 ...
 * predictability). I've pre-populated the props with some values generated by running through
 * some fractals. They seed the transforms nicely, and will keep the frame jitters down (which
 * happens when shifting the graph to center on the transforms).
 *
 ...
 */
const transforms = {
  transformX: -0.7706696991731463,
  transformY: 0.09999999275498782
};
